            ...
            <div className="grid grid-cols-2 items-center mt-10">
                <div className="col-span-1">
                    ...
                    <div className='mx-auto flex flex-row justify-center mt-[2rem]'>
                        ...
                        <a href={"https://github.com/KoyuncuSinan/gadget-box"}  target="_blank" className='py-[0.5rem] rounded-lg px-[1.5rem] font-medium text-lg border-2 border-black hover:bg-black hover:text-white'>GitHub</a>
                     </div>
                     <div>Demo email&password:</div>
                    <div>test1@test.com</div>
                    <div className="ml-2">test1</div>
                </div>
