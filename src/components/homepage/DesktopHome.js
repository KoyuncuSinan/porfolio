...
export default function DesktopHome(){
  ...
  const handleFullstackClick = () => {
    ...
    return(
        ...
        <Image src={picture} width={800} height={800} className="rounded-full object-cover"></Image>
        </div>
      </section>
    ...
    <div className="mt-12 col-span-1 w-[80%]">
        <h3 className="font-bold text-xl mb-4">Get to know me</h3>
         ...
         <div className='mt-2'>Throughout my journey as a web content editor, I developed a deep understanding of the importance of <b>user experience</b> and captivating content. 
